...
export default function ExpressiveLiteracyAlgebra() {
        ...
        <main className="w-full max-w-[480px] min-h-[100dvh] mx-auto flex flex-col bg-bone-white font-inter relative shadow-xl overflow-x-hidden">
            ...
            <header className="bg-pine-green w-full z-20">
                <div className="flex items-center justify-between px-6 py-4">
                    <Link href="/diagnostic/domain-ib/receptive" className="text-bone-white hover:opacity-80 transition-opacity">
                        <X size={24} />
                    </Link>
            ...
            <div className="flex-1 flex flex-col px-6 pt-6 pb-32">
                ...
                <div className="bg-white rounded-[16px] border border-gray-200 p-6 flex flex-col shadow-sm mb-8">
                    <p className="font-inter text-[17px] text-pine-dark mb-6">
                        A student tells you:
                    </p>
                    ...
                    <blockquote className="my-6 border-l-4 border-gray-300 pl-4 py-2">
                        <p className="font-playfair italic text-[18px] text-pine-green leading-relaxed">
                            &quot;When I expand <span className="font-inter not-italic font-semibold tracking-wide mx-1">(x + 3)<sup>2</sup></span>, I just square the x and square the 3, so the answer is <span className="font-inter not-italic font-semibold tracking-wide mx-1">x<sup>2</sup> + 9</span>.&quot;
                        </p>
                    </blockquote>

                    <p className="font-inter text-[17px] text-pine-dark leading-relaxed">
                        How would you respond? Address the misconception using mathematical language appropriate for a secondary student.
                    </p>
                </div>
                ...
                <div className="flex flex-col space-y-3">
                    ...
                    <div className="flex items-center justify-between">
                        <p className="font-inter text-[14px] text-gray-500 leading-tight pr-4">
                            Aim for 3&ndash;5 sentences. Write as if speaking to a 9th grader.
                        </p>
                        <span className={`font-inter text-[13px] flex-shrink-0 ${text.length >= charLimit ? 'text-red-500 font-semibold' : 'text-gray-500'}`}>
                ...
                <div className="mt-auto pt-8">
                    <Link
                        href={isSubmittable ? "/diagnostic/domain-ib/confidence" : "#"}
