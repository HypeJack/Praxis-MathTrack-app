...
export default function ReceptiveLiteracyAlgebra() {
        ...
        <main className="w-full max-w-[480px] min-h-[100dvh] mx-auto flex flex-col bg-bone-white font-inter relative shadow-xl overflow-x-hidden">
            ...
            <header className="bg-pine-green w-full z-20">
                <div className="flex items-center justify-between px-6 py-4">
                    <Link href="/diagnostic/domain-ib/computation" className="text-bone-white hover:opacity-80 transition-opacity">
                        <X size={24} />
                    </Link>
            ...
            <div className="flex-1 flex flex-col px-6 pt-6 pb-32">
                ...
                {/* Step 3: Problem Card & Math Typography Fix */}
                <div className="bg-white rounded-[16px] border border-gray-200 p-6 flex flex-col shadow-sm mb-8">
                    <p className="font-inter text-[17px] text-pine-dark mb-6">
                        A textbook presents the following statement:
                    </p>
                    ...
                    <blockquote className="my-6 border-l-4 border-gray-300 pl-4 py-2">
                        <p className="font-playfair italic text-[18px] text-pine-green leading-relaxed">
                            &quot;The solution set of <span className="font-inter not-italic font-semibold tracking-wide mx-1">|2x &minus; 5| &lt; 3</span> is the set of all x such that <span className="font-inter not-italic font-semibold tracking-wide mx-1">1 &lt; x &lt; 4</span>.&quot;
                        </p>
                    </blockquote>

                    <p className="font-inter text-[17px] text-pine-dark leading-relaxed">
                        Interpret this statement. What does the absolute value inequality represent geometrically on a number line? What does the solution set mean in context?
                    </p>
                </div>
                ...
                <div className="mt-auto pt-8">
                    <Link
                        href={isSubmittable ? "/diagnostic/domain-ib/expressive" : "#"}
