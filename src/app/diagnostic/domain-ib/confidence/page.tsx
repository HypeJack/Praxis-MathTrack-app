...
export default function AlgebraConfidenceRating() {
        ...
        <main className="w-full max-w-[480px] min-h-[100dvh] mx-auto flex flex-col bg-bone-white font-inter relative shadow-xl overflow-x-hidden">
            ...
            <header className="bg-pine-green w-full z-20">
                <div className="flex items-center justify-between px-6 py-4">
                    <Link href="/diagnostic/domain-ib/expressive" className="text-bone-white hover:opacity-80 transition-opacity">
                        <X size={24} />
                    </Link>
            ...
            <div className="flex-1 flex flex-col px-6 pt-10 pb-32">
                ...
                <div className="mb-12">
                    <h1 className="font-playfair font-bold text-[30px] text-pine-green leading-tight mb-4">
                        One last thing for Algebra — How did that feel?
                    </h1>
                    <p className="font-inter text-[17px] text-pine-dark opacity-90">
                        Rate your confidence in Algebra from 1 to 5.
                    </p>
                </div>
                ...
                <div className="mt-auto pt-8">
                    <Link
                        href={rating ? "/diagnostic/domain-ib/transition" : "#"}
