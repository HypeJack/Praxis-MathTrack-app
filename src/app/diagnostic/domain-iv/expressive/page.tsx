...
export default function ExpressiveLiteracyDomainIV() {
        ...
        <main className="w-full max-w-[480px] min-h-[100dvh] mx-auto flex flex-col bg-bone-white font-inter relative shadow-xl overflow-x-hidden">
            ...
            <header className="bg-pine-green w-full z-20">
                <div className="flex items-center justify-between px-6 py-4">
                    <Link href="/diagnostic/domain-iv/receptive" className="text-bone-white hover:opacity-80 transition-opacity">
                        <X size={24} />
                    </Link>
            ...
            <div className="flex-1 flex flex-col px-6 pt-6 pb-32">
                ...
                <div className="bg-white rounded-[16px] border border-gray-200 p-6 flex flex-col shadow-sm mb-8">
                    ...
                    <blockquote className="my-6 border-l-4 border-gray-300 pl-4 py-2">
                        <p className="font-playfair italic text-[18px] text-pine-green leading-relaxed">
                            &quot;I flipped a fair coin and got heads four times in a row. The next flip has to be tails because the probability is 50/50 and it needs to even out.&quot;
                        </p>
                    </blockquote>

                    <p className="font-inter text-[17px] text-pine-dark leading-relaxed">
                        How would you respond? Address the student&apos;s misunderstanding of independent events.
                    </p>
                </div>
                ...
                <div className="flex flex-col space-y-3">
                    ...
                    <div className="flex flex-col items-end space-y-2">
                        ...
                        <p className="font-inter text-[14px] text-gray-500 text-right italic leading-snug">
                            Aim for 3&ndash;5 sentences. Write as if speaking to a high school statistics student.
                        </p>
                    </div>
                </div>
                ...
                <div className="mt-auto pt-8">
                    <Link
                        href={isSubmittable ? "/diagnostic/domain-iv/confidence" : "#"}
