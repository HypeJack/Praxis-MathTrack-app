...
export default function IntroDomainIV() {
    return (
        <main className="w-full max-w-[480px] min-h-[100dvh] mx-auto flex flex-col bg-bone-white font-inter relative shadow-xl overflow-x-hidden">
            ...
            <header className="bg-pine-green w-full z-20">
                <div className="flex items-center justify-between px-6 py-4">
                    <Link href="/diagnostic/domain-iii/transition" className="text-bone-white hover:opacity-80 transition-opacity">
                        <X size={24} />
                    </Link>
            ...
            <div className="flex-1 flex flex-col px-6 pt-12">
                ...
                {/* Step 3: Intro Card */}
                <div className="bg-green-tint rounded-[16px] border border-pine-green p-8 flex flex-col space-y-4 shadow-sm relative overflow-hidden">
                    <h2 className="font-playfair font-bold text-[24px] text-pine-green">
                        Let&apos;s look at the data.
                    </h2>
                    <p className="font-inter text-[17px] text-pine-dark/90 leading-relaxed z-10">
                        You&apos;ll work through 3 short tasks covering data distributions, probability models, and analyzing student statistical reasoning. Almost at the finish line!
                    </p>

                    {/* Decorative Graph Element (Abstract) */}
                ...
                <div className="mt-auto pt-12">
                    <Link
                        href="/diagnostic/domain-iv/computation"
