...
export default function ExpressiveLiteracyDomainII() {
        ...
        <main className="w-full max-w-[480px] min-h-[100dvh] mx-auto flex flex-col bg-bone-white font-inter relative shadow-xl overflow-x-hidden">
            ...
            <header className="bg-pine-green w-full z-20">
                <div className="flex items-center justify-between px-6 py-4">
                    <Link href="/diagnostic/domain-ii/receptive" className="text-bone-white hover:opacity-80 transition-opacity">
                        <X size={24} />
                    </Link>
            ...
            <div className="flex-1 flex flex-col px-6 pt-6 pb-32">
                ...
                <div className="bg-white rounded-[16px] border border-gray-200 p-6 flex flex-col shadow-sm mb-8">
                    <p className="font-inter text-[17px] text-pine-dark mb-4">
                        A student tells you:
                    </p>

                    <blockquote className="my-6 border-l-4 border-gray-300 pl-4 py-2">
                        <p className="font-playfair italic text-[18px] text-pine-green leading-relaxed">
                            &quot;Since the derivative of <span className="font-inter not-italic font-semibold tracking-wide mx-1 text-pine-dark">x<sup>3</sup></span> is <span className="font-inter not-italic font-semibold tracking-wide mx-1 text-pine-dark">3x<sup>2</sup></span>, the derivative of <span className="font-inter not-italic font-semibold tracking-wide mx-1">e<sup>x</sup></span> must be <span className="font-inter not-italic font-semibold tracking-wide mx-1">x &middot; e<sup>x-1</sup></span>.&quot;
                        </p>
                    </blockquote>

                    <p className="font-inter text-[17px] text-pine-dark leading-relaxed">
                        How would you respond? Address why the power rule does not apply here.
                    </p>
                </div>
                ...
                <div className="flex flex-col space-y-3">
                    <textarea
                        ...
                        placeholder="Tap to type your explanation..."
                    ...
                    <div className="flex flex-col items-end space-y-2">
                        ...
                        <p className="font-inter text-[14px] text-gray-500 text-right italic">
                            Aim for 3&ndash;5 sentences. Write as if speaking to an AP Calculus student.
                        </p>
                    </div>
                </div>
                ...
                <div className="mt-auto pt-8">
                    <Link
                        href={isSubmittable ? "/diagnostic/domain-ii/confidence" : "#"}
