...
export default function DomainIIConfidenceRating() {
        ...
        <main className="w-full max-w-[480px] min-h-[100dvh] mx-auto flex flex-col bg-bone-white font-inter relative shadow-xl overflow-x-hidden">
            ...
            <header className="bg-pine-green w-full z-20">
                <div className="flex items-center justify-between px-6 py-4">
                    <Link href="/diagnostic/domain-ii/expressive" className="text-bone-white hover:opacity-80 transition-opacity">
                        <X size={24} />
                    </Link>
            ...
            <div className="flex-1 flex flex-col px-6 pt-10 pb-32">
                ...
                <div className="mb-12">
                    ...
                    <p className="font-inter text-[17px] text-pine-dark opacity-90">
                        Rate your confidence in Functions & Calculus from 1 to 5.
                    </p>
                </div>
                    ...
                    {rating && (
                        <div className="w-full bg-accent-gold/10 border border-accent-gold/30 rounded-[12px] p-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
                            <p className="text-center font-inter font-semibold text-[15px] text-accent-gold">
                                Selected: {rating} &mdash; {ratingLabels[rating]}
                            </p>
                        </div>
                    )}
                </div>
                ...
                <div className="mt-auto pt-8">
                    <Link
                        href={rating ? "/diagnostic/domain-ii/transition" : "#"}
