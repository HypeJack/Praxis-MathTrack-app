...
export default function ReceptiveLiteracyDomainIII() {
        ...
        <main className="w-full max-w-[480px] min-h-[100dvh] mx-auto flex flex-col bg-bone-white font-inter relative shadow-xl overflow-x-hidden">
            ...
            <header className="bg-pine-green w-full z-20">
                <div className="flex items-center justify-between px-6 py-4">
                    <Link href="/diagnostic/domain-iii/computation" className="text-bone-white hover:opacity-80 transition-opacity">
                        <X size={24} />
                    </Link>
            ...
            <div className="flex-1 flex flex-col px-6 pt-6 pb-32">
                ...
                <div className="bg-white rounded-[16px] border border-gray-200 p-6 flex flex-col shadow-sm mb-8">
                    <p className="font-inter text-[17px] text-pine-dark mb-4">
                        A geometry textbook presents the following definition:
                    </p>
                    ...
                    <blockquote className="my-6 border-l-4 border-gray-300 pl-4 py-2">
                        <p className="font-playfair italic text-[18px] text-pine-green leading-relaxed">
                            &quot;Two geometric figures are similar if and only if there exists a sequence of rigid motions and dilations that maps one figure onto the other.&quot;
                        </p>
                    </blockquote>

                    <p className="font-inter text-[17px] text-pine-dark leading-relaxed">
                        Interpret this definition. In your own words, why must the definition of similarity include &quot;dilations&quot; while the definition of congruence does not?
                    </p>
                </div>
                ...
                <div className="mt-auto pt-8">
                    <Link
                        href={isSubmittable ? "/diagnostic/domain-iii/expressive" : "#"}
