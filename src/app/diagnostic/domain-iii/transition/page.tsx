...
export default function TransitionDomainIII() {
    ...
    return (
        <main className="w-full min-h-[calc(100dvh-64px)] bg-pine-green flex flex-col items-center justify-center px-6 py-12 font-inter text-center relative shadow-xl overflow-x-hidden">
            ...
            <div className="w-full max-w-md flex flex-col items-center">
                <p className="text-bone-white font-inter italic mb-6 animate-in fade-in duration-1000 delay-1000">
                    Just 1 domain left. Let's look at the data.
                </p>

                <Link
                    href="/diagnostic/domain-iv/intro"
                ...
                >
                    On to Statistics & Probability &rarr;
                </Link>
            </div>
